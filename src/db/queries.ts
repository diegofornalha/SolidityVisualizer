...
export async function saveDiagram(prompt: string, diagramCode: string, title?: string) {
...
export async function updateDiagram(id: number, updates: { prompt?: string; diagram?: string; title?: string }) {
